...
const FormateurFormationSessions = () => {
    ...
    return (
        <Container fluid className="admin-formations p-0">
            ...
            <div className="mb-4">
                <div className="mb-3">
                    <Button variant="link" className="p-0 text-dark text-decoration-none d-inline-flex align-items-center" onClick={() => navigate('/formateur/formations')}>
                                ...
                                <tr key={session.id} className="border-bottom">
                                    ...
                                    <td className="pe-4 py-3 text-end">
                                        <div className="d-flex justify-content-end gap-3">
                                            <Button variant="link" className="p-0 text-muted" onClick={() => navigate(`/formateur/sessions/${session.id}`)}>
