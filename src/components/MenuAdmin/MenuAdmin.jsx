        ...
        <div className="admin-layout">
            <aside className="admin-sidebar">
                ...
                <nav className="sidebar-nav">
                    ...
                    <NavLink to="/admin/formations" className={({ isActive }) => `sidebar-link ${isActive ? 'active' : ''}`}>
                        <FontAwesomeIcon icon={faBook} className="sidebar-icon" />
                        <span>Formations</span>
                    </NavLink>
                    <NavLink to="/admin/utilisateurs" className={({ isActive }) => `sidebar-link ${isActive ? 'active' : ''}`}>
                        <FontAwesomeIcon icon={faUsers} className="sidebar-icon" />
                        <span>Utilisateurs</span>
                    </NavLink>
                    <NavLink to="/admin/formateurs" className={({ isActive }) => `sidebar-link ${isActive ? 'active' : ''}`}>
